...
classdef PDist < dagnn.Loss
  ...
  methods
    function outputs = forward(obj, inputs, params)
      switch numel(inputs)
        case 2
            inputs{2} = reshape(inputs{2},1,1,1,[]);
          outputs{1} = vl_nnpdist(inputs{1}, inputs{2}, obj.p, [], ...
            'aggregate', obj.aggregate, obj.opts{:},'noRoot',obj.noRoot) ;
        case 3
          outputs{1} = vl_nnpdist(inputs{1}, inputs{2}, obj.p, [], ...
      ...
      switch numel(inputs)
        case 2
          ...
          [derInputs{1}, derInputs{2}] = vl_nnpdist(inputs{1}, inputs{2}, ...
            obj.p, derOutputs{1}, 'aggregate', obj.aggregate, obj.opts{:},'noRoot',obj.noRoot) ;
        case 3
          [derInputs{1}, derInputs{2}] = vl_nnpdist(inputs{1}, inputs{2}, ...
